...
<div style=" background-color: #102e44; height:100px; color:blue; padding-left:70px; "></div> 
 <!-- TOPBAR --> 
  ...
  <div class="container" style="margin: 20px 10px 0px 310px; background-color:white; height:500px;width: 70%">
...
<input type="hidden" name = "action" value="signupStaff"> <br>
</form>

<a style="margin-left: 260px;" href='LoginController?id= <%session.getAttribute("Staff_ID");%>'>Register</a>
</div>
</body>
</html>