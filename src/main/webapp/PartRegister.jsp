...
<!-- TOPBAR -->      
 ...
 <!-- TOPBAR -->   
	...
	<div class="container" style="margin: 20px 10px 0px 210px; background-color:#004a80; height:600px; ">
		<h2 style="padding-top: 1em; padding-left:1em;">COURSE REGISTRATION</h2>
		<img src="rrr.jpg" style="width:50%; position: absolute; left:35em;" >
		<input type="button" value="HAJJ COURSE" style="padding: 14px 40px; position: relative; left:5em; top:15em; width: 20%; align: center;">
		<br><br>
		<input type="button" value="UMRAH COURSE" style="padding: 14px 40px; position: relative; left:5em; top:15em; width: 20%; align: center;">
	</div>
