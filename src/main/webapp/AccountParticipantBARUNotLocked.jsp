...
<a href="Register.jsp" class="btn2" style="display:block;padding:50px;">REGISTER COURSE</a> 
<a href="#"  style="display:block;padding:50px;">CLASS SCHEDULE</a>  
<a href="#"  style="display:block;padding:50px;">ANNOUNCEMENT</a> 
<a href="AccountParticipantBARU.jsp" class="btn6" style="display:block;padding:50px;">ACCOUNT</a> 
<a href="PartLogin.jsp" class="btn8" style="display:block;padding:50px;">LOGOUT</a> 
...
%> 
  ...
  <p style="font-size:30px;text-align:center;"><b>ACCOUNT </b></p> 
      ...
      <button onclick="document.getElementById('id02').style.display='block'" type="submit" id="myBtn" style="background-color: red;color:white;position: relative; left:10px; width: 100px;border-color:grey;padding: 10px; border-radius: 10px;margin-left:850px;">Deactivate Account</button> 
