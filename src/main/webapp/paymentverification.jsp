...
<tbody style="border: solid black 1px;">
   ...
   <tr>
     ...
     <td style=" text-align: center; border: solid black 1px;"><%=res.getString("payment_date")%></td>
     <td style=" text-align: center; border: solid black 1px;"><%=res.getString("paymnet_time")%></td>

    
     <td class="text-center" style=" text-align: center; border: solid black 1px;">
        <a href='ViewSchedule.jsp?u=<%=res.getString("schedule_id")%>' class="btn btn-warning" style= "background-color: #37fd12;">Verify</a>
