...
<!-- TOPBAR -->      
 ...
 <!-- TOPBAR -->   
	...
	<div class="container" style="margin: 20px 10px 0px 210px; background-color:#004a80; height:700px; ">
		<h2 style="float: left; margin-top: 5em;">UMRAH COURSE</h2>
            <p style="background-color: lightgrey; width:50%; border: 5px solid black; padding-top: 2em; padding: 250px 75px; margin-left: 20em; margin-top: 5em;">Please upload your payment receipt here:
            <br><br>
