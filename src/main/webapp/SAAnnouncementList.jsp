...
<br><br>
 <a href='SACreateAnnouncement.jsp?id= <%session.getAttribute("Staff_ID");%>' style="  margin-left:1450px; margin-right:20px;font-size:20px; height:5px; text-align: center; background-color: #353c49; border-radius: 20px; padding:20px;">Add Announcement</a>
		<br><br>
	</div>
