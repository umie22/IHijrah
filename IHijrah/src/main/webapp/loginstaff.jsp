      ...
      <div class="form-style">
        <form>
          <div class="form-group pb-3">
            ...
            <!-- input type="staffid" placeholder="Staff Id" class="form-control" id="exampleInputstaffid" 
          </div> -->
          <div class="form-group pb-3">
          ...
          <div class="pb-2">
            <button type="login" class="btn btn-dark w-100 font-weight-bold mt-2"><a href="dashboardstaff.html">Login</a></button>
          </div>
        </form>
